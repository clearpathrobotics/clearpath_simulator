...
targets [Gazebo](https://gazebosim.org) instead of real hardware, reusing the same `robot.yaml`,
...
- [Install the simulator](https://docs.clearpathrobotics.com/docs/ros/tutorials/simulator/install) and [run a simulation](https://docs.clearpathrobotics.com/docs/ros/tutorials/simulator/simulate).
- [Navigation demos](https://docs.clearpathrobotics.com/docs/ros/tutorials/navigation_demos/overview) — Nav2 / SLAM on top of the simulated robot.
- [Generators](https://docs.clearpathrobotics.com/docs/ros/config/generators) — how the simulation launch/param files are produced.
